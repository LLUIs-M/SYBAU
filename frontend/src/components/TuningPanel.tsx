...
export default function TuningPanel({ options, onChange, onClose, triggerEl }: Props) {
  ...
  return createPortal(
    <div 
      ref={panelRef}
      style={style}
      className="w-72 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/10 rounded-xl shadow-2xl animate-in fade-in zoom-in-95 p-5"
    >
      <div className="flex items-center gap-2 mb-4 text-zinc-800 dark:text-zinc-200">
        ...
        <span className="font-semibold text-sm">Model Tuning</span>
      </div>
